...
the release workflow syncs repo without current-branch filtering so nested UEFI
projects fetch their pinned SHA even when an old commit is no longer reachable
from the declared upstream branch tip.
